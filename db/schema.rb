...
ActiveRecord::Schema[8.1].define(version: 2025_11_08_010156) do
  ...
  create_table "feed_entries", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_feed_entries_on_post_id"
    t.index ["user_id", "author_id"], name: "index_feed_entries_on_user_id_and_author_id"
    t.index ["user_id", "created_at"], name: "index_feed_entries_on_user_id_and_created_at_desc", order: { created_at: :desc }
    t.index ["user_id", "post_id"], name: "index_feed_entries_on_user_id_and_post_id", unique: true
  end
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["redacted", "created_at"], name: "index_posts_on_redacted_and_created_at"
    t.index ["redacted"], name: "index_posts_on_redacted"
  end
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["post_id", "created_at"], name: "index_reports_on_post_id_and_created_at"
    t.index ["post_id", "reporter_id"], name: "index_reports_on_post_and_reporter", unique: true
    t.index ["post_id"], name: "index_reports_on_post_id"
    t.index ["reporter_id", "created_at"], name: "index_reports_on_reporter_id_and_created_at"
  ...
  create_table "user_admins", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_user_admins_on_user_id", unique: true
  end
  ...
  add_foreign_key "feed_entries", "posts", on_delete: :cascade
